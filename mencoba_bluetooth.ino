...
#define rxPin           0
#define txPin           1
SoftwareSerial mamakau(rxPin,txPin);
int data=0,kec=0;
boolean maju=true;
int laju [11]={0,80,100,120,140,160,180,200,220,240,255};
...
void motorout(unsigned char lpwm,unsigned char rpwm,boolean arrow)
{
  if (arrow==true)
  {
      digitalWrite(L_EN_1, HIGH);
      digitalWrite(R_EN_1, HIGH);
      analogWrite (LPWM_1, lpwm);
      analogWrite (RPWM_1, 0);
      digitalWrite(L_EN_2, HIGH);
      digitalWrite(R_EN_2, HIGH);
      analogWrite (LPWM_1, 0);
      analogWrite (RPWM_1, rpwm);
  }
...
if (data=='S') {motorout(0,0,false);}
else if (data=='F') {motorout (laju[kec],laju[kec],true);}
else if (data=='I') {motorout (laju[kec],laju[kec/2],true);}
else if (data=='G') {motorout (laju[kec/2],laju[kec],true);}
else if (data=='H') {motorout (laju[kec/2],laju[kec],false);}
else if (data=='j') {motorout (laju[kec],laju[kec/2],false);}
else if (data=='L') {motorout (0,laju[kec],true);}
else if (data=='R') {motorout (laju[kec],0,true);}
else if (data=='B') {motorout (laju[kec],laju[kec],false);}
}
